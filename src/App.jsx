            ...
            <div className="page">
              ...
              <div className="about-section">
                ...
                {[
                  ...
                  { icon:"◎", text:"Waiver targets - discover truly available players (not already rostered) that fit your needs and scoring format." },
              ...
              <div className="about-section">
                ...
                {[
                  ...
                  { icon:"⇄", text:"When evaluating a trade, select the opponent first - their roster won't appear until you do." },
