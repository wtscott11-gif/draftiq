            ...
            <div className="page">
              ...
              <div className="about-section">
                ...
                {[
                  ...
                  { icon:"📊", text:"Stats load in the background - player points and projections may take a few seconds to appear after selecting a league. The AI includes them automatically once loaded." },
                  { icon:"👆", text:"Tap any player chip to see their full season stats, week-by-week point chart, and current week projection." },
                  { icon:"📋", text:"Check the Scoring and Settings tabs in any league to understand exactly how your league scores - useful context before asking trade questions." },
                ].map((t, i) => (
                  <div key={i} className="tip-card">
                    <div className="tip-icon">{t.icon}</div>
                    <div className="tip-text">{t.text}</div>
              ...
              <div className="about-section">
                ...
                <div className="tip-card">
                  ...
                  <div className="tip-text">All roster, league, and player data comes directly from the Sleeper public API and reflects your live league in real time. Stats are sourced from Sleeper's data provider and update throughout the week. Projections are Sleeper's current-week estimates for each player.</div>
                </div>
              </div>
