        ...
        <div className="page">
          ...
          <div className="about-section">
            ...
            {[
              ...
              { n:"3", title:"Explore your roster", desc:"Tap My Roster to see your full team with last week's actual points and this week's projections on every player. Tap any player for a full stat breakdown." },
              { n:"4", title:"Check out other teams", desc:"In the Leagues tab, tap any team in the standings to see their full roster and player stats — useful for identifying trade targets." },
