...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
  ...
  .bar-fill { width: 100%; border-radius: 3px 3px 0 0; background: var(--green); min-height: 2px; transition: height .4s; }
...
function PlayerSheet({ playerId, players, playerStats, playerProjections, currentSeason, currentWeek, onClose }) {
  ...
  const lastWeekSt = playerStats[playerId] || {};
